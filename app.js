...
VIEW_H = WALL_DI * 2 + TABLE_H + RETURN_H;var

Ball = function () {
  function Ball(_ref) {var number = _ref.number,cueball = _ref.cueball;_classCallCheck(this, Ball);
    this.cue = number === 0;
    this.eight = number === 8;
    ...
    this.build();
  }_createClass(Ball, [{ key: 'setInitialCoordinates', value: function setInitialCoordinates()
    ...
    {
      var pos = Ball.positions[this.number].map(function (p) {return rel(p);});
      this.x = pos[0];
      this.y = pos[1];
    ...
    } }, { key: 'pocket', value: function pocket(_ref2)
    ...
    {var x = _ref2.x,y = _ref2.y;
      ...
      Body.update(this.body, 0, 0, 0);
    } }, { key: 'setVelocity', value: function setVelocity(_ref3)
    ...
    } }, { key: 'fromCueball', get: function get() {return { angle: Vector.angle(this.body.position, this.cueball.body.position) };} }], [{ key: 'positions', get: function get()
...
Table = function () {
  function Table() {_classCallCheck(this, Table);
    this.width = TABLE_W;
    this.height = TABLE_H;
    this.hypot = Math.hypot(TABLE_W, TABLE_H);
    this.build();
  }_createClass(Table, [{ key: 'build', value: function build()

    {
      this.buildBounds();
      this.buildWall();
      this.buildPockets();
    } }, { key: 'buildBounds', value: function buildBounds()
    ...
    } }, { key: 'buildWall', value: function buildWall()
    ...
    } }, { key: 'buildPockets', value: function buildPockets()
    ...
    } }], [{ key: 'wallVertices', get: function get()
...
Machine = function () {
  function Machine() {_classCallCheck(this, Machine);
    this.clock = 0;
    this.fireCount = 0;
    this.x = rel(TABLE_W * 0.5);
    this.y = rel(TABLE_H * 0.5);
  }_createClass(Machine, [{ key: 'reset', value: function reset(_ref4,

    placingCueball) {var x = _ref4.x,y = _ref4.y;
      if (placingCueball) {
        this.x = rel(TABLE_W * 0.5);
        this.y = rel(TABLE_H * 0.5);
      } else {
...
Player = function () {
  function Player(number) {_classCallCheck(this, Player);
    this.number = number;
    this.stripes = false;
    this.solids = false;
    this.points = 0;
  }_createClass(Player, [{ key: 'assign', value: function assign(
    stripes) {
    ...
    count) {
      this.points += count;
    } }, { key: 'onEight', get: function get() {return this.points === 7;} }, { key: 'winner', get: function get() {return this.points === 8;} }, { key: 'denomText', get: function get() {if (this.stripes) return 'Stripes';if (this.solids) return 'Solids';return '';} }, { key: 'invalidContactText', get: function get() {if (this.stripes) return this.nameText + ' did not hit a Stripe first.';if (this.solids) return this.nameText + ' did not hit a Solid first.';} }, { key: 'nameText', get: function get() {if (this.number === 1) return '<strong>You</strong>';return '<strong>AI</strong>';} }, { key: 'eightText', get: function get() {return this.nameText + ' Pocketed the Eight.';} }, { key: 'scratchText', get: function get() {return this.nameText + ' Scratched!';} }, { key: 'turnText', get: function get() {var txt = this.number === 1 ? 'Your' : 'AI\'s';txt = '<strong>' + txt + '</strong>';txt += ' Turn ';if (this.stripes || this.solids) txt += '(' + this.denomText + ')';return txt;} }, { key: 'winText', get: function get() {if (this.number === 1) return '<strong>You</strong> Win!';return '<strong>AI</strong> Wins!';} }, { key: 'teamText', get: function get() {return this.nameText + ' is ' + this.denomText;} }]);return Player;}();var


Canvas = function () {
  function Canvas(_ref5) {var context = _ref5.context;_classCallCheck(this, Canvas);
    this.context = context;
  }_createClass(Canvas, [{ key: 'drawCrosshair', value: function drawCrosshair(_ref6)
    ...
    {var x = _ref6.x,y = _ref6.y;
      ...
      this.context.fill();
    } }, { key: 'drawMovingCrosshair', value: function drawMovingCrosshair(_ref7)
    ...
    } }, { key: 'drawTable', value: function drawTable(_ref8)

    {var wallBodies = _ref8.wallBodies,pocketBodies = _ref8.pocketBodies;
      this.drawSlate();
      this.drawWall(wallBodies);
      this.drawReturn();
      this.drawPockets(pocketBodies);
      this.drawPoints();
    } }, { key: 'drawSlate', value: function drawSlate()

    {
      ...
      this.context.fillRect(WALL_RAD, WALL_RAD, TABLE_W + WALL_DI, TABLE_H + WALL_DI);
    } }, { key: 'drawReturn', value: function drawReturn()
    ...
    } }, { key: 'drawWall', value: function drawWall(

    wallBodies) {var _this = this;
      this.context.fillStyle = COLORS.frame;
      wallBodies.forEach(function (body, i) {
        _this.context.beginPath();
        body.vertices.forEach(function (_ref9, j) {var x = _ref9.x,y = _ref9.y;
          if (j === 0) {
        ...
        _this.context.save();
        _this.context.beginPath();
        body.vertices.forEach(function (_ref10, j) {var x = _ref10.x,y = _ref10.y;
          if (j === 0) {
            _this.context.moveTo(x, y);
          } else {
            _this.context.lineTo(x, y);
    ...
    } }, { key: 'drawPockets', value: function drawPockets(

    pocketBodies) {var _this2 = this;
      this.context.fillStyle = COLORS.pocket;
      pocketBodies.forEach(function (_ref11) {var position = _ref11.position,circleRadius = _ref11.circleRadius;
        _this2.context.beginPath();
        _this2.context.arc(position.x, position.y, circleRadius, 0, PI2, false);
        _this2.context.fill();
      });
    } }, { key: 'drawPoints', value: function drawPoints()
    ...
    } }, { key: 'drawIndicator', value: function drawIndicator(_ref12)

    {var x = _ref12.x,y = _ref12.y,cueball = _ref12.cueball,power = _ref12.power,maxDistance = _ref12.maxDistance;
      ...
      this.context.stroke();
      this.context.closePath();
    } }, { key: 'drawBalls', value: function drawBalls(_ref13)

    {var balls = _ref13.balls,ballIds = _ref13.ballIds;
      var inAngle = [];
    ...
    } }, { key: 'drawBall', value: function drawBall(
...
Game = function () {
  function Game(_ref14) {var _this4 = this;var world = _ref14.world,canvas = _ref14.canvas,sounds = _ref14.sounds;_classCallCheck(this, Game);
    ...
    initEscapedBodiesRetrieval(this.ballIds.map(function (id) {return _this4.balls[id].body;}));
    this.reset();
  }_createClass(Game, [{ key: 'handleEscapedBall', value: function handleEscapedBall(
    ...
    {var _this5 = this;
      ...
      this.ballIds.forEach(function (ballId) {return _this5.balls[ballId].reset();});
      this.updateDOM();
    } }, { key: 'addBodiesToWorld', value: function addBodiesToWorld()
    {var _this6 = this;
      World.add(this.world, this.table.bounds);
      World.add(this.world, this.table.walls);
      World.add(this.world, this.table.pockets);
      World.add(this.world, this.ballIds.map(function (b) {return _this6.balls[b].body;}));
...

    {
      ...
      this.strikeCueball();
    } }, { key: 'handlePocketed', value: function handlePocketed(

    ballId) {
      var ball = this.balls[ballId];
      if (ball.cue) this.setupCueball();
      this.handlePocketedBall(ball);
    } }, { key: 'handlePocketedBall', value: function handlePocketedBall(
    ...
    ball) {
      ...
      ball.pocket({ x: x, y: y });
    } }, { key: 'handleTickAfter', value: function handleTickAfter(_ref15)
    ...
    } }, { key: 'handleCollisionActive', value: function handleCollisionActive(_ref16)

    {var _this7 = this;var pairs = _ref16.pairs;
      pairs.forEach(function (_ref17, i) {var bodyA = _ref17.bodyA,bodyB = _ref17.bodyB;
        ...
        if (coll === 'ballpocket' || coll == 'pocketball') {
          ...
          _this7.handlePocketed(ball.id);
        }
      });
    } }, { key: 'handleCollisionStart', value: function handleCollisionStart(_ref18)

    {var _this8 = this;var pairs = _ref18.pairs;
      if (this.placingCueball) return;
      pairs.forEach(function (collision, i) {var
        bodyA = collision.bodyA,bodyB = collision.bodyB;
        var speed = collision.collision.axisBody.speed;
        var coll = bodyA.label + bodyB.label;
        if (!_this8.firstContact && coll === 'ballball')
        _this8.firstContact = [bodyA, bodyB];
        if (coll === 'ballball') {
    ...
    // logic for valid first contact, scoring, and game end.
  }, { key: 'handleTurnEnd', value: function handleTurnEnd() {var _this9 = this;
      this.restBalls();
      this.messages = [];
      this.power = 0;
      ...
      var isCue = pocketed.filter(function (b) {return b.cue;}).length > 0,
      isEight = pocketed.filter(function (b) {return b.eight;}).length > 0;

      // determining valid first contact
      var validFirstContact = true;
      if (this.firstContact) {
        var balls = this.firstContact.map(function (b) {return _this9.balls[b.id];});
        var ball = balls.filter(function (b) {return !b.cue;})[0];
      ...
      if (pocketed.length > 0) {
        var stripes = pocketed.filter(function (b) {return b.stripes;}),
        solids = pocketed.filter(function (b) {return b.solids;}),
    ...
    } }, { key: 'messageTurn', value: function messageTurn()

    {
      this.messages.push(this.currentPlayer.turnText);
    } }, { key: 'messageScratch', value: function messageScratch()

    {
      this.messages.push(this.currentPlayer.scratchText);
    } }, { key: 'messageInvalidContact', value: function messageInvalidContact()

    {
      this.messages.push(this.currentPlayer.invalidContactText);
    } }, { key: 'messageEight', value: function messageEight()

    {
      this.messages.push(this.currentPlayer.eightText);
    } }, { key: 'messageWin', value: function messageWin(

    winner) {
      this.messages.push(winner.winText);
    } }, { key: 'restBalls', value: function restBalls()

    {var _this11 = this;
      this.ballIds.forEach(function (id) {return _this11.balls[id].rest();});
    } }, { key: 'strikeCueball', value: function strikeCueball()
    ...
    } }, { key: 'setupCueball', value: function setupCueball()

    {
      this.cueball.disable();
      this.placingCueball = true;
    } }, { key: 'placeCueball', value: function placeCueball()

    {
      this.cueball.enable();
      this.cueball.pocketed = false;
      this.placingCueball = false;
    } }, { key: 'moveCueball', value: function moveCueball(
    ...
    } }, { key: 'tickPower', value: function tickPower()
...

    {
      ...
      this.$message.innerHTML = '<p>' + this.messages.map(function (m) {return m;}).join(' ') + '</p>';
    } }, { key: 'updatePlayerDOM', value: function updatePlayerDOM(

    player, current) {
      return '<span>\n  <span>' +
      player.nameText + '</span>\n  <span>' +
      player.points + '</span>\n</span>';

    } }, { key: 'switchTurns', value: function switchTurns()

    {
      this.currentPlayerIdx++;
    } }, { key: 'checkMovement', value: function checkMovement()
    ...
    } }, { key: 'currentPlayer', get: function get() {return this.players[this.currentPlayerIdx % 2];} }, { key: 'otherPlayer', get: function get() {return this.players[(this.currentPlayerIdx + 1) % 2];} }, { key: 'isMachine', get: function get() {return this.currentPlayerIdx % 2 !== 0;} }, { key: 'aMachineBall', get: function get()

    {var _this12 = this;
      var balls = this.ballIds.map(function (id) {return _this12.balls[id];}).filter(function (b) {return !b.pocketed;});
      if (this.players[1].onEight) {
        balls = [this.eightball];
      } else if (this.players[1].stripes) {
        balls = balls.filter(function (b) {return b.stripes;});
      } else if (this.players[1].solids) {
        balls = balls.filter(function (b) {return b.solids;});
      } else {
        balls = balls.filter(function (b) {return !b.cue && !b.eight;});
      }
      return balls[Math.floor(Math.random() * balls.length)];
    } }, { key: 'cueball', get: function get()

    {
      return this.balls[this.cueId];
    } }, { key: 'eightball', get: function get()

    {
      return this.balls[this.eightId];
    } }, { key: 'ballNumbers', get: function get()
...
if (window.location.href.match(/cpgrid/)) {
  ...
  Events.on(constraint, 'mousedown', function (_ref19) {var mouse = _ref19.mouse;
    _game.handleMousedown();
  });
  Events.on(constraint, 'mouseup', function (_ref20) {var mouse = _ref20.mouse;
    _game.handleMouseup();
  });
...
function initEscapedBodiesRetrieval(allBodies) {
  function hasBodyEscaped(body) {var _body$position =
    body.position,x = _body$position.x,y = _body$position.y;
    return x < 0 || x > VIEW_W || y < 0 || y > VIEW_H;
  }

  setInterval(function () {
    var i = void 0,body = void 0;
